...
| Voice capture and transcription | Not implemented | None | No `audio.start`/`audio.stop`, no speech-to-text adapter, no transcript events. Commands are reserved in `docs/API_CONTRACTS.md` only |
