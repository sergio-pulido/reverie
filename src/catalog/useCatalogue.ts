...
import type { CatalogueRequest, CatalogueState } from "../discover/catalogueClient";
import { useCatalogueRead, type CatalogueRead } from "../discover/CatalogueReadContext";
import { createFeedController, EMPTY_FEED, seedFeed, type Feed, type PageResult } from "./pageFeed";

export type { CatalogueState } from "../discover/catalogueClient";
...
/**
 * A request for the catalogue grid: an unrefined browse pages through the default page size, a
 ...
 * never asks for more. A new query or refinement starts again from page 1.
 */
export function useCatalogue(query: string, filters: CatalogueFilters | null) {
