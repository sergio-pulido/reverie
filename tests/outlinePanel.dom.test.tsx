...
describe("the outline panel", () => {
  ...
  it("shows what the queue did with each edit, in the server's own words", async () => {
    edits = [
      ...
      { id: "a", jamId: JAM, requestId: "r1", intent: "set", beatIndex: 2, summary: "the stair floods", mechanism: "direct", status: "landed", queuedAt: "2026-09-20T12:00:00.000Z", revision: 4 },
    ];
    const container = await render(<OutlinePanel jamId={JAM} canEdit />);
    ...
    assert.match(ledger[1], /“the stair floods”/);
  });
});
