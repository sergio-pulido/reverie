 ...
 * era, with the Movie Jam spotlight among them. A remote moves along a shelf with Left and Right
 ...
 * catalogue reads.
 */
export function HomeScreen({ onOpenFilm, onStartJam, onJoin, inert = false, shelves }: HomeScreenProps) {
  ...
  const rows = useMemo(() => homeRows(states, hero, unavailable), [states, hero, unavailable]);
 ...
 */
function homeRows(states: readonly ShelfState[], hero: CatalogueTitle | null, unavailable: boolean): HomeRow[] {
